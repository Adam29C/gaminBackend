...
const updateGameRulesStatus = async (req, res) => {
    try {
        const { role } = req.decoded;
...
module.exports = { createSubAdminFn, userAndSubAdminList, usersCreatedBySubAdmin, gamesCreatedByAdmin, gamesUpdatedByAdmin, gamesDeletedByAdmin, gamesList, addAmount, paymentHistory, addRules, updateRules,deleteRules,getRules,updateGameRulesStatus }
